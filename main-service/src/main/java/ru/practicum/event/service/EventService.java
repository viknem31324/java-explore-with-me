...
public interface EventService {
    ...
    List<EventFullDto> findPrivateAllEventsByUser(Long userId, Pageable pageable);

    EventFullDto createEventByUser(Long userId, NewEventDto newEventDto);

    EventFullDto findPrivateEventForUserByEventId(Long userId, Long eventId);
    ...
    List<EventShortDto> findAllPublicEventsByPublic(String text,
    ...
    EventFullDto updatePrivateEventByUser(Long userId,
                                   Long eventId,
